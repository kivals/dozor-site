...
export function ContactSection() {
  return (
    <section id="contacts" className="py-6 lg:px-16 lg:py-10">
      <div className="relative overflow-hidden rounded-[20px] bg-navy px-5 pt-10 lg:rounded-[40px] lg:px-16 lg:py-14">
        {/* Soft glow accent */}
